...
import com.traf7.youngrio.animatedgame.GameObject;
import com.traf7.youngrio.animatedgame.GameSurface;
...
public class ChibiCharacter extends GameObject {
    ...
    private int movingVectorX = (int) randomX;
    private int movingVectorY = (int) randomY;
